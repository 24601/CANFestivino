...
class objdictedit(wx.Frame, NodeEditorTemplate):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.HelpBar = wx.StatusBar(id=ID_OBJDICTEDITHELPBAR, name='HelpBar',
              parent=self, style=wx.STB_DEFAULT_STYLE)
...
#-------------------------------------------------------------------------------
    ...
    def OnOpenMenu(self, event):
        ...
        dialog = wx.FileDialog(self, _("Choose a file"), directory, "",  _("OD files (*.od)|*.od|All files|*.*"))
        if dialog.ShowModal() == wx.ID_OK:
    ...
    def SaveAs(self):
        ...
        dialog = wx.FileDialog(self, _("Choose a file"), directory, filename,  _("OD files (*.od)|*.od|All files|*.*"))
        if dialog.ShowModal() == wx.ID_OK:
            filepath = dialog.GetPath()
...
#-------------------------------------------------------------------------------
    ...
    def OnImportEDSMenu(self, event):
        ...
        dialog = wx.FileDialog(self, _("Choose a file"), os.getcwd(), "",  _("EDS files (*.eds)|*.eds|All files|*.*"))
        if dialog.ShowModal() == wx.ID_OK:
            filepath = dialog.GetPath()
            if os.path.isfile(filepath):
    ...
    def OnExportEDSMenu(self, event):
        ...
        dialog = wx.FileDialog(self, _("Choose a file"), os.getcwd(), self.Manager.GetCurrentNodeInfos()[0], _("EDS files (*.eds)|*.eds|All files|*.*"))
        if dialog.ShowModal() == wx.ID_OK:
            filepath = dialog.GetPath()
            if os.path.isdir(os.path.dirname(filepath)):
    ...
    def OnExportCMenu(self, event):
        ...
        dialog = wx.FileDialog(self, _("Choose a file"), os.getcwd(), self.Manager.GetCurrentNodeInfos()[0],  _("CANFestival C files (*.c)|*.c|All files|*.*"))
        if dialog.ShowModal() == wx.ID_OK:
            filepath = dialog.GetPath()
            if os.path.isdir(os.path.dirname(filepath)):
                path, extend = os.path.splitext(filepath)
